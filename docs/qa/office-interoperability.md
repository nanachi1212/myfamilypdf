...
這項回歸使用 Microsoft Office 本體的內容、Layout 物件及 Word 原生 renderer，比只讀取 OOXML ZIP 結構更接近實際使用，能抓出空白輸出、分頁、混合文字樣式、同頁多表格、工作表範圍及欄寬問題。三頁固定 fixture 已完成預覽巡覽。一般等寬雙欄已另完成來源、封裝 helper 與 OOXML 重讀；四頁 Word COM fixture 已加入，但本次隔離帳號缺少互動式 Office 工作階段，尚未產生新的 Word 本體證據。不等寬／三欄以上、浮動圖片、跨頁表格及精確座標版面仍不在證據範圍，特殊字型也可能需要人工整理。
